...
mycon = sql.connect(host="localhost", user="root", password="root", database="Databricks")
mycur = mycon.cursor()
while True:
    print("\n")
    ...
    print("Press 1 to for Crete New Account ")
    print("Press 2 to for Login  ")
    try:
        ...
        if (isalpha(ch)) or (ch >= 3):
            ...
            while True:
                try:
                    ...
                    if (a in ut) or (a1 in ut) or (a3 in ut) or (a4 in ut) or (a5 in ut) or (a6 in ut) or (
                            a7 in ut) or (a8 in ut) or (a9 in ut):
                        raise TypeError
                    break
                except TypeError:
            ...
            while True:
                try:
                    ...
                    if (a in p) or (a1 in p) or (a2 in p) or (a3 in p) or (a4 in p) or (a5 in p) or (a6 in p) or (
                            a7 in p) or (a8 in p) or (a9 in p):
                        raise TypeError
                    break
        ...
        if data:
            while True:
                ...
                if (ch1 == 1):
                    ...
                    while True:
                        try:
                            ...
                            if a11.isalpha():
                                ...
                                mn = "insert into transaction values('{}','{}','{}','{}')".format(a11, Debited, u,
                                                                                                  dates1)
                                mycur.execute(mn)
                                mycon.commit()
                                np9 = "select Balance from bank where UserName='{}'".format(u)
                    ...
                    nmm = "Select Name,UserName,Password,  Address,  Mobile_Number, Aadhar_no, Balance from bank where UserName='{}'".format(
                        u)
                    mycur.execute(nmm)
                    print("______________________________________________________________________________")
                    ...
                    print("*************Thanks For Choosing Banking Application *****************")
                    print("____________________________________________________________________________")
                    exit()
